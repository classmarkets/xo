...
type ArgType struct {
	...
	RenameTypes   []string `arg:"--rename-types,help:use specified type names instead of deriving them from the table names. --type-names \"table_1=FooType table_2=BarType\""`
